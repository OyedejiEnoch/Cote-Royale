...
const FragranceList: FC<FragranceListProps> = ({ slice }) => {
  return (
    ...
    >
      ...
      <RevealText field={slice.primary.heading} as={"h2"} id={`fragrance-list-heading-${slice.id}`} align="center" 
      duration={1.5} staggerAmount={.3} className="font-display text-5xl sm:text-6xl uppercase md:text-7xl lg:text-8xl " />
