    ...
    <Bounded className="py-10">
        <div className="grid grid-cols-1 items-center gap-10 pb-10 lg:grid-cols-2">
            <div className="relative mb-14 flex justify-center pb-10">
                <PrismicNextImage field={page.data.bottle_image} width={600} height={600} priority className="absolute top-[90%]
                -scale-y-100 [mask-image:linear-gradient(to_bottom,rgba(0,0,0,0)_70%,rgba(0,0,0,.15)_100%))]" />
                <PrismicNextImage field={page.data.bottle_image} width={600} height={600} priority className="relative" />
            </div>
            ...
            <div className="text-white">
                ...
                <div className="space-y-6 text-gray-300">
                    ...
                    <button className="w-full py-3 text-black bg-white font-medium uppercase transition hover:bg-neutral-200
                    duration-200">Add to bag</button>
                    ...
                    <div className="flex items-center gap-4 border-t border-neutral-700 pt-6">
                        ...
                        <div className="flex">
                            {[...Array(4)].map((_, i) =>(
                                <HiStar className="size-5 text-white" key={i} />
                            ))}
...
export async function generateMetadata({
  ...
  return {
    title: asText(page.data.title) + " | Côte Royaale",
    description: `Discover ${asText(page.data.title)} - An exquisite fragrance from Côte Royaale.`,
    openGraph: {
