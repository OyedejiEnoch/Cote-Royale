...
interface SettingsDocumentData {
  ...
  /**
   * Fall Back OG Image field in *Settings*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.fall_back_og_image
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  fall_back_og_image: prismic.ImageField<never>;
...
export interface ScrolltextSliceDefaultPrimary {
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: scrolltext.default.primary.eyebrow
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  eyebrow: prismic.KeyTextField;
   ...
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: scrolltext.default.primary.text
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
